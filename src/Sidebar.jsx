            ...
            <div className="sidebar">
                        ...
                        <ul className="custom-list">
                            {allCategories.map(category => (
                             <div className="custom-list-item" key={category}>
                                <li className={`item js-category ${selectedCategory === category ? "active" : ""}`}
                ...
                <div className="sidebar-item">
                    ...
                    <div className="sidebar-content">
                        <div className="price-bar">
                            <input type="number" placeholder={minPricePossible} className="input" value={minPrice} onChange={(e) => setMinPrice(e.target.value)}/>
                            <input type="number" placeholder={maxPricePossible} className="input" value={maxPrice} onChange={(e) => setMaxPrice(e.target.value)}/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="sidebar-content">
                        <div className="colors">
                            {allColors.map(color => (
                                ...
                                <input type="checkbox" className="color-checkbox" id={`color-${color}`} checked={selectedColors.includes(color)} onChange={() => handleColorChange(color)} />
                ...
                <div className="sidebar-item">
                    <div className="button-wrapper">
                        <button className="button button-apply-filter" id="apply-filter" onClick={handleApplyFilter}>Apply Filter</button>
